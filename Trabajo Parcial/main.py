...
url = 'https://drive.google.com/file/d/1HjHXgWs0Is9qlIz-gSKmIqiZDixi-6XH/view?usp=sharing'
id = url.split('/')[-2]
url2 = f'https://drive.google.com/uc?id={id}'
output = 'Trabajo Parcial\\'
gdown.download(url2, output, quiet=False)

video_cap = cv2.VideoCapture('Feria5.mp4')
